...
export const braumCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A controlled lane where Braum can stand near his ADC, block key spells, and punish enemies who commit into passive stacks.",
    wants: [
  ...
  majorPowerSpikes: ["Level 2 (Q)+passive threat.", "Level 3 adds full peel with (E).", "Level 6 (R) adds lane engage and disengage."],
  matchupPreferences: {
    strongInto: [
      "Projectile poke.",
      "Dive supports.",
      "ADCs that must walk forward into passive.",
  ],
    weakInto: [
      "Sustain poke lanes.",
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Mark with (Q) or auto, let the ADC stack passive, and use (E) to block the enemy's strongest return damage.",
  punishProfile: {
    canPunish: [
  ...
  strategicIdentity: {
    ...
    scalingProfile: "mid",
    winMethod: ["Blocking key spells.", "Stacking passive quickly.", "Counter-engaging enemy all-ins."],
  },
  supportSynergy: {
  ...
  trading: {
    ...
    primaryPattern: "Mark with (Q) or auto, let the ADC stack passive, and use (E) to block the enemy's strongest return damage.",
  },
  punishWindows: [
