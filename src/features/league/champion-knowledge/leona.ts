...
export const leonaCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A lane where Leona's side can reach level 2 or level 3 first, thin the wave, and force enemies to respect engage from brush.",
    wants: [
      "Brush control.",
      "ADC burst ready.",
      "Enemy wave thin enough to engage through.",
  ],
  },
  laneIdentity: {
    ...
    preferredGameState: [
      "Kill lanes.",
      "Dragon fights with first move.",
      "Pick setups from fog.",
  ],
    scalingPriority: "medium",
    winLaneBy: [
      "Level 2 all-ins.",
      "Layering stuns for ADC damage.",
      "Roaming after crash.",
  ],
  },
  majorPowerSpikes: ["Level 2 (E)+(Q) all-in.", "Level 3 adds (W) durability.", "Level 6 (R) starts fights from range."],
  matchupPreferences: {
    strongInto: [
      "Immobile ADCs.",
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Threaten from brush, engage only with ADC damage in range, and layer (Q) after (E) connects.",
  punishProfile: {
    canPunish: [
  ...
  trading: {
    ...
    primaryPattern: "Threaten from brush, engage only with ADC damage in range, and layer (Q) after (E) connects.",
  },
  punishWindows: [
