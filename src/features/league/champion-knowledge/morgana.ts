...
export const morganaCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A controlled lane where Morgana holds (E) for enemy engage and uses brush or minion gaps to land (Q) for ADC follow-up.",
    wants: [
  ...
  majorPowerSpikes: [
    "Level 2 binding plus shield threat.",
    "Level 3 adds wave/poke zone.",
    "Level 6 Soul Shackles all-in.",
  ],
  matchupPreferences: {
    strongInto: ["Hook and stun supports.", "Immobile ADCs.", "Trap ADC lanes."],
    weakInto: [
      "Long-range poke.",
  ...
  primaryTradingPattern:
    "Hold Black Shield for the enemy's key CC, fish for (Q) from brush, and convert root duration into ADC damage.",
  punishProfile: {
    canPunish: [
  ...
  sustain: [],
  trading: {
    badTradeConditions: ["(Q) misses.", "(E) is baited.", "Her ADC cannot hit the rooted target."],
    goodTradeConditions: [
