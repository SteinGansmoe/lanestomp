...
export const viktorCombatProfile = {
  ...
  damageType: "magic",
  hardCrowdControl: ["(W) stun after delay"],
  id: "Viktor",
    ...
    major: [
      {
        ...
        reason: "Level 6 (R)",
        changesGameplay:
          "Viktor's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Viktor's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Viktor's first item threshold is completed.",
      },
    ],
    minor: [
      {
        ...
        changesGameplay:
          "Viktor gains more lane coverage, but the matchup should still revolve around (R), item, and evolution progress.",
        playerAction:
          "Use level 3 to manage spacing and wave control rather than forcing extended trades.",
        enemyResponse:
          "Punish misplaced (W) or wave-only spell usage instead of treating level 3 as a kill spike.",
      },
    ],
  },
  primaryRoles: ["mid"],
  secondaryRoles: ["top"],
  primaryTradingPattern: "Trade with (E) and (Q) shield while keeping (W) for disengage.",
  punishProfile: {
    canPunish: [],
    strugglesToPunish: [
      "Immobile and vulnerable to hard engage.",
  ...
  shields: ["(Q)"],
  softCrowdControl: ["(W) slow before stun"],
  ...
  trading: {
    ...
    goodTradeConditions: [],
    primaryPattern: "Trade with (E) and (Q) shield while keeping (W) for disengage.",
  },
  punishWindows: [
    "If Viktor place (W) in a bad spot, he is vulnerable.",
    "If Viktor uses abilities on wave clear only he can be punished by enemy laner.",
