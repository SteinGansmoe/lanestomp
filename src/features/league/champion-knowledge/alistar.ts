...
export const alistarCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A slightly pushing or neutral bot lane where Alistar owns brush and can threaten level 2 or level 3 all-ins without losing too much HP first.",
    wants: [
      "Brush control.",
  ...
  majorPowerSpikes: [
    "Level 2 (W)+(Q) all-in.",
    "Level 3 adds (E) stun threat.",
    "Level 6 (R) enables dives and durable peel.",
  ],
  matchupPreferences: {
    strongInto: ["Immobile poke lanes that lose brush control.", "Dive lanes he can interrupt."],
    weakInto: [
  ...
  primaryTradingPattern:
    "Hold brush or flank space, threaten (W)+(Q), and only commit when the ADC can hit during the knockup.",
  punishProfile: {
    canPunish: [
