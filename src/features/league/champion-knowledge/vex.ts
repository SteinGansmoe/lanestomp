    ...
    major: [
      {
        ...
        reason: "Level 6 (R)",
        changesGameplay:
          "Vex's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Vex's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Vex's first item threshold is completed.",
      },
    ],
  },
  primaryRoles: ["mid"],
  secondaryRoles: [],
  primaryTradingPattern: "Use passive fear to win trades and easily proc electrocute.",
  punishProfile: {
    canPunish: [],
    strugglesToPunish: [
      "Immobile outside ultimate reset windows.",
