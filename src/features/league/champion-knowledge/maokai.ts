...
export const maokaiCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A brush-control lane where saplings own the side brush and Maokai can start short all-ins when the enemy ADC steps forward.",
    wants: ["Brush control.", "ADC follow-up for rooted targets.", "River objective setups."],
  },
  laneIdentity: {
  ...
  majorPowerSpikes: [
    "Level 2 (W)+(Q) trade.",
    "Level 3 sapling control.",
    "Level 6 Nature's Grasp engage.",
  ],
  matchupPreferences: {
    strongInto: ["Low mobility ADCs.", "Melee engage lanes.", "Objective-heavy comps."],
    weakInto: [
      "Long-range poke.",
  ...
  primaryTradingPattern:
    "Stack brush with saplings, threaten (W) from fog, and use (Q) to keep targets in ADC range.",
  punishProfile: {
    canPunish: [
      "Face-checks.",
