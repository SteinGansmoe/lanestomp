...
export const zileanCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A utility lane where Zilean controls bomb zones, speeds ADC trades, and saves revive for the enemy's committed burst.",
    wants: [
  ...
  laneIdentity: {
    ...
    lanePressure: "medium",
    preferredGameState: ["Scaling utility lanes.", "Anti-burst fights.", "Kiting fights."],
    scalingPriority: "high",
    winLaneBy: ["Landing double bomb.", "Speeding ADC windows.", "Reviving the focused carry."],
  },
  majorPowerSpikes: [
    "Level 2 bomb plus speed.",
    "Level 3 Rewind double-bomb threat.",
    "Level 6 Chronoshift.",
  ],
  matchupPreferences: {
    strongInto: ["Burst lanes.", "Immobile ADCs needing speed.", "Teams that dive one target."],
    weakInto: [
  ...
  primaryTradingPattern:
    "Set bombs on the wave or slowed targets, use speed to control trade distance, and hold (R) for real lethal damage.",
  punishProfile: {
    canPunish: [
