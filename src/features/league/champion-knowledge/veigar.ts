...
export const veigarCombatProfile = {
  ...
  majorPowerSpikes: ["Level 6 (R).", "First completed mage item plus stack growth."],
  matchupPreferences: {
    strongInto: [
  ...
  powerSpikes: {
    major: [
      ...
      },
      {
        ...
        enemyResponse:
          "Do not treat pre-item trades as still safe once Veigar's first item threshold is completed.",
      },
    ],
    minor: [
      {
        ...
        changesGameplay:
          "(E) is his key defensive and pick tool, and can be used to stop engages or trap enemies for burst windows",
        playerAction:
          "Use (E) mainly to deny commits or punish trapped movement while continuing to build stacks safely.",
        enemyResponse:
          "Track (E) cooldown carefully; pressure is much safer after cage is unavailable.",
      },
    ],
  },
  primaryRoles: ["mid"],
  secondaryRoles: ["adc", "support"],
  primaryTradingPattern: "Secure stacks, punish movement with (E), then burst trapped targets.",
  punishProfile: {
    canPunish: [
