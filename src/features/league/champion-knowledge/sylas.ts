...
export const sylasCombatProfile = {
  ...
  primaryWinCondition: [
    "Use (E) to engage or threaten, then look for extended trades with (W) and stolen ultimates.",
  ],
    ...
    major: [
      {
        ...
        changesGameplay:
          "The early ability combination gives Sylas a real trade or all-in pattern instead of isolated lane pressure.",
        playerAction:
          "Use the unlocked combo only when cooldowns, minions, and spacing make the trade hard to punish.",
        enemyResponse:
          "Respect the early combo unlock and avoid giving Sylas the wave or spacing needed to start it cleanly.",
      },
      {
        timing: "Level 6",
        reason: "Level 6 (R) if valuable ultimates are available",
        changesGameplay:
          "Sylas's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Sylas's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Sylas's first item threshold is completed.",
      },
    ],
  },
  primaryRoles: ["mid"],
