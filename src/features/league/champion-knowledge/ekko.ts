...
export const ekkoCombatProfile = {
  ...
  primaryWinCondition: [
    "Short trades with (Q) and (E), a well-times (W) stun can turn a fight in his favor, and (R) can be used to dodge key damage or reset fights.",
  ],
    ...
    major: [
      {
        ...
        changesGameplay:
          "The early ability combination gives Ekko a real trade or all-in pattern instead of isolated lane pressure.",
        playerAction:
          "Use the unlocked combo only when cooldowns, minions, and spacing make the trade hard to punish.",
        enemyResponse:
          "Respect the early combo unlock and avoid giving Ekko the wave or spacing needed to start it cleanly.",
      },
      {
        timing: "Level 6",
        reason: "Level 6 (R)",
        changesGameplay:
          "Ekko's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Ekko's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Ekko's first item threshold is completed.",
      },
    ],
  },
  primaryRoles: ["jungle"],
