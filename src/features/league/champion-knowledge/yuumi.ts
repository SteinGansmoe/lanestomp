...
export const yuumiCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A defensive scaling lane where Yuumi keeps her ADC healthy, pokes with guided (Q), and avoids unnecessary detach risks.",
    wants: [
      "Safe scaling ADC.",
  ...
  laneIdentity: {
    earlyGameAgency: "low",
    lanePressure: "low",
    preferredGameState: ["Scaling lanes.", "Host-carry fights.", "Extended chase or kite fights."],
    scalingPriority: "high",
    winLaneBy: ["Sustaining trades.", "Enhancing a fed host.", "Landing (R) through enemy path."],
  },
  majorPowerSpikes: [
    "Level 2 attach sustain.",
    "Level 3 guided poke plus speed.",
    "Level 6 Final Chapter.",
  ],
  matchupPreferences: {
    strongInto: ["Scaling carries.", "Mobile hosts.", "Lanes that cannot hard engage early."],
    weakInto: ["Hard engage lanes.", "Lane bullies.", "Comps that punish her ADC before scaling."],
  },
  mobilityLevel: "none",
  name: "Yuumi",
  offMetaRoles: [],
  ...
  primaryTradingPattern:
    "Stay attached for safety, poke with guided (Q), heal speed-ups for trade exits, and detach only when CC is tracked.",
  punishProfile: {
    canPunish: [
  ...
  sustain: ["(E) healing."],
  trading: {
    badTradeConditions: ["Host is chunked.", "(E) is down.", "Yuumi detaches near CC."],
    goodTradeConditions: [
