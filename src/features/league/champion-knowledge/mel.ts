...
export const melCombatProfile = {
  ...
  primaryWinCondition: [
    "Poke and mark enemies from range, use (W) to deny key projectiles, then finish marked targets with (R).",
  ],
  dangerAbilities: ["(W) projectile reflect", "(E) root", "(R) global mark detonation"],
  dangerProfile: {
    dangerousWhen: [
  ...
  laneIdentity: {
    ...
    preferredGameState: [
      ...
      "Projectile-heavy matchups where (W) has high value.",
