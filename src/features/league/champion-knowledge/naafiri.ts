...
export const naafiriCombatProfile = {
  ...
  dangerAbilities: ["W Hounds' Pursuit targeted dash", "Q Darkin Daggers bleed", "R The Call of the Pack engage steroid"],
  dangerProfile: {
    dangerousWhen: [
  ...
  shields: ["R The Call of the Pack shield on champion combat trigger"],
  softCrowdControl: [],
