...
export const aurelionSolCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "Farm-focused control mage who uses his stars for waveclear and roaming, scales into a strong teamfight presence.",
    wants: [""],
  },
  laneIdentity: {
    earlyGameAgency: "low",
    ...
    lanePressure: "medium",
    preferredGameState: [
      "Lane that allows him to farm up safely and reach his mid-late game power spikes.",
      "Late game teamfights and skirmishes where he can use his roaming and AoE damage to have a big impact.",
    ],
    winLaneBy: [""],
  },
  majorPowerSpikes: [
    ...
    major: [
      {
        ...
        changesGameplay:
          "Aurelion Sol's scaling turns more lane-neutral states into teamfight or chase pressure.",
        playerAction:
          "Play toward stable farm, safe resets, and fights where the scaling payoff can actually matter.",
        enemyResponse:
          "Pressure earlier windows and avoid letting Aurelion Sol reach the scaling state for free.",
      },
      {
        timing: "Rylai's completed",
        reason: "Once Rylais is completed, he becomes much harder to run from",
        changesGameplay:
          "Aurelion Sol's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Aurelion Sol's first item threshold is completed.",
      },
      {
  ...
  primaryRoles: ["mid"],
  secondaryRoles: ["top"],
  primaryTradingPattern: "(E) into (Q) for poke and waveclear",
  punishProfile: {
    canPunish: [],
    strugglesToPunish: [
      "Aurelion Sol is weak early game, he's main focus is to farm up and scale into a strong mid-late game threat.",
