...
export const brandCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A poke lane where Brand can stand behind the wave, hit (W) or (E), and threaten stun if enemies walk through his fire zones.",
    wants: [
  ...
  majorPowerSpikes: ["Level 2 poke plus stun setup.", "Level 3 full Blaze combo.", "Level 6 (R) bounce all-in."],
  matchupPreferences: {
    strongInto: [
      "Short-range lanes.",
      "Grouped engage comps.",
      "Low-sustain ADCs.",
  ],
    weakInto: [
      "Hard engage supports.",
      "Long-range sustain lanes.",
      "Mobile ADCs that dodge (W).",
  ],
  },
  mobilityLevel: "none",
  name: "Brand",
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Apply Blaze with (W) or (E), threaten empowered (Q), and avoid walking forward after cooldowns are spent.",
  punishProfile: {
    canPunish: [
  ...
  strategicIdentity: {
    ...
    scalingProfile: "mid",
    winMethod: ["Landing repeated (W).", "Threatening stun after Blaze.", "Turning level 6 bounces into all-in damage."],
  },
  supportSynergy: {
  ...
  trading: {
    ...
    primaryPattern: "Apply Blaze with (W) or (E), threaten empowered (Q), and avoid walking forward after cooldowns are spent.",
  },
  punishWindows: [
