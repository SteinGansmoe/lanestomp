...
export const blitzcrankCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A lane where Blitzcrank can hold brush, thin enough minions to expose hook angles, and threaten ADC last hits with (Q).",
    wants: [
      "Brush control.",
      "Minion gaps.",
      "ADC burst ready after hook.",
  ],
  },
  laneIdentity: {
    ...
    winLaneBy: [
      "Landing (Q).",
      "Forcing enemy ADC away from CS.",
      "Roaming after bot wave crash.",
  ],
  },
  majorPowerSpikes: ["Level 2 (Q)+(E) all-in.", "Level 3 adds (W) chase speed.", "Level 6 adds silence burst."],
  matchupPreferences: {
    strongInto: [
      "Immobile carries.",
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Hold hook threat longer than the enemy wants, then pull when minion cover or escape cooldowns are gone.",
  punishProfile: {
    canPunish: [
  ...
  trading: {
    ...
    primaryPattern: "Hold hook threat longer than the enemy wants, then pull when minion cover or escape cooldowns are gone.",
  },
  punishWindows: [
