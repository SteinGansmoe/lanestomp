...
export const seraphineCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A wave-control lane where Seraphine pokes safely, uses empowered (W) to stabilize, and layers (E) with ADC slows.",
    wants: ["Grouped allies.", "ADC slows or roots.", "Wave states where she can poke and shield."],
  },
  laneIdentity: {
    earlyGameAgency: "medium",
    lanePressure: "medium",
    preferredGameState: ["Poke lanes.", "Sustain lanes.", "Grouped teamfights."],
    scalingPriority: "high",
    winLaneBy: ["Layering (E).", "Sustaining trades.", "Landing multi-target (R)."],
  },
  majorPowerSpikes: [
    "Level 2 poke plus slow/root setup.",
    "Level 3 shield sustain.",
    "Level 6 Encore.",
  ],
  matchupPreferences: {
    strongInto: ["Grouped enemies.", "ADCs with slows.", "Teamfight comps."],
    weakInto: ["Hard engage.", "Flank assassins.", "Long-range artillery that outranges her."],
  },
  mobilityLevel: "none",
  name: "Seraphine",
  offMetaRoles: [],
  ...
  primaryTradingPattern:
    "Poke with (Q), use (E) after slows, and save empowered (W) or (R) for committed fights.",
  punishProfile: {
    canPunish: [
