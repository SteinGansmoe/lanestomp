...
export const tristanaCombatProfile = {
  ...
  majorPowerSpikes: ["Level 2 all-in.", "First completed marksman item.", "Late-game range scaling."],
  matchupPreferences: {
    strongInto: [
    ...
    major: [
      {
        ...
        changesGameplay:
          "Tristana can punish ADCs that lose the race to level 2.",
        playerAction:
          "Push for level 2 with support cover and jump only when follow-up is ready.",
        enemyResponse:
          "Back away before level 2 if she and her support hit it first.",
      },
      {
        timing: "First completed marksman item",
        reason: "All-in burst and turret pressure become more reliable",
        changesGameplay:
          "Winning one trade can quickly become plates or dragon priority.",
        playerAction:
          "Turn forced recalls into turret damage with (E).",
        enemyResponse:
          "Deny clean jumps and punish her passive wave push.",
      },
    ],
  },
  primaryRoles: ["adc"],
