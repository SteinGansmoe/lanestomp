...
export const rakanCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A mobile lane where Rakan uses brush, minions, and ally position to threaten (W) while keeping (E) available to exit or peel.",
    wants: ["ADC positioned for (E).", "Fog or flank engage.", "Grouped enemies for level 6."],
  },
  laneIdentity: {
    earlyGameAgency: "medium",
    lanePressure: "medium",
    preferredGameState: ["Fast engage lanes.", "Skirmishes.", "Teamfights with flank access."],
    scalingPriority: "high",
    winLaneBy: ["Landing (W).", "Charming multiple targets.", "Peeling back with (E)."],
  },
  ...
  primaryTradingPattern:
    "Dash in with (W), let the ADC hit the knockup, then (E) out or re-enter when cooldowns allow.",
  punishProfile: {
    canPunish: [
