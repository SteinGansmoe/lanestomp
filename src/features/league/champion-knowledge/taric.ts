...
export const taricCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A defensive or all-in lane where Taric links to his ADC, threatens stun through their movement, and sustains extended fights.",
    wants: [
      "ADC that commits forward.",
      "Enemy dive into his team.",
      "Extended trades.",
  ],
  },
  laneIdentity: {
    ...
    winLaneBy: [
      "Landing linked stun.",
      "Sustaining with (Q).",
      "Timing (R) before lethal burst.",
  ],
  },
  majorPowerSpikes: ["Level 2 heal plus stun.", "Level 3 Bastion linked angles.", "Level 6 Cosmic Radiance."],
  matchupPreferences: {
    strongInto: [
      "Dive comps.",
      "Melee supports.",
      "ADCs that want committed fights.",
  ],
    weakInto: [
      "Long-range poke.",
      "Disengage that waits out (R).",
      "Lanes that kite his stun.",
  ],
  },
  mobilityLevel: "low",
  name: "Taric",
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Link with (W), threaten (E) from both positions, and use (R) before the enemy burst lands.",
  punishProfile: {
    canPunish: [
  ...
  trading: {
    badTradeConditions: [
      "(E) misses.",
      "(R) is baited.",
      "ADC fights outside Bastion range.",
  ],
    goodTradeConditions: [
      "Enemy must commit.",
    ...
    primaryPattern: "Link with (W), threaten (E) from both positions, and use (R) before the enemy burst lands.",
  },
  punishWindows: [
