...
export const sonaCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A defensive scaling lane where Sona trades lightly with (Q), sustains with (W), and avoids hard engage until level 6.",
    wants: ["Scaling ADC.", "Short safe poke trades.", "Enemy engage cooldowns tracked."],
  },
  laneIdentity: {
    earlyGameAgency: "low",
    lanePressure: "low",
    preferredGameState: ["Scaling lanes.", "Grouped teamfights.", "Anti-dive with Crescendo."],
    scalingPriority: "very_high",
    winLaneBy: ["Surviving early.", "Stacking aura value.", "Landing (R) on commits."],
  },
  ...
  matchupPreferences: {
    ...
    weakInto: ["Hard engage.", "Hook supports.", "Early burst lanes."],
  },
  mobilityLevel: "low",
  name: "Sona",
  offMetaRoles: [],
  ...
  primaryTradingPattern:
    "Take small empowered-auto trades only when safe, heal the return damage, and preserve health until scaling and (R).",
  punishProfile: {
    canPunish: [
  ...
  trading: {
    ...
    goodTradeConditions: ["Enemy engage misses.", "ADC can scale safely.", "Teamfight is grouped."],
    primaryPattern:
      "Take small empowered-auto trades only when safe, heal the return damage, and preserve health until scaling and (R).",
  },
  punishWindows: [
