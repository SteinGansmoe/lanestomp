...
export const karmaCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A pushing lane where Karma lands Mantra (Q), shields ADC trades, and uses wave control to secure plates or river vision.",
    wants: ["Wave push.", "Poke angles through brush.", "ADC ready to trade when shielded."],
  },
  laneIdentity: {
  ...
  majorPowerSpikes: [
    "Level 1 Mantra poke.",
    "Level 3 poke plus root plus shield.",
    "First support item upgrade improves tempo.",
  ],
  matchupPreferences: {
    strongInto: ["Scaling enchanters.", "Short-range lanes.", "ADCs that struggle under turret."],
    weakInto: [
  ...
  primaryTradingPattern:
    "Push with Mantra (Q), shield the ADC's forward trade, and use (W) only when the enemy cannot break tether safely.",
  punishProfile: {
    canPunish: [
