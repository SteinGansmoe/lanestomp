...
export const oriannaCombatProfile = {
  ...
  primaryWinCondition: [
    "Control the lane with ball placement and create opportunities for teamfighting.",
  ],
    ...
    major: [
      {
        ...
        reason: "Level 6 (R)",
        changesGameplay:
          "Orianna's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Orianna's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Orianna's first item threshold is completed.",
      },
    ],
  },
  primaryRoles: ["mid"],
