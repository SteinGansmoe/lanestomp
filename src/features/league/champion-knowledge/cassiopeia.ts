...
export const cassiopeiaCombatProfile = {
  ...
  dangerAbilities: ["W Miasma grounding", "R Petrifying Gaze stun or slow"],
  dangerProfile: {
    dangerousWhen: [
  ...
  damageType: "magic",
  hardCrowdControl: ["R Petrifying Gaze stun"],
  id: "Cassiopeia",
  ...
  lanePlan: {
    ...
    wants: [
      ...
      "Mobility champions forced to fight inside Miasma.",
    ],
  },
  laneIdentity: {
  ...
  shields: [],
  softCrowdControl: ["W Miasma slow", "R Petrifying Gaze slow if enemies are not facing her"],
  stealthOrInvisibility: null,
  sustain: ["E Twin Fang heals when used on poisoned targets."],
  trading: {
    badTradeConditions: [
