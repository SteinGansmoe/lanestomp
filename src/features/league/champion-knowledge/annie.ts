...
export const annieCombatProfile = {
  ...
  dangerAbilities: ["(R) stun and damage", "Passive Pyromania stun on 4th stack"],
  dangerProfile: {
    dangerousWhen: ["(R) stun and damage", "Passive Pyromania stun on 4th stack"],
    mustRespect: [
      "Annie's main trading pattern is to proc her passive with (Q) and (W) for burst damage and stun.",
      "(R) is her main pick tool, it can be used to engage or follow up on engages.",
  ...
  majorPowerSpikes: [
    "Level 6 is a huge power spike for Annie, as (R) gives her a strong pick tool and significant burst damage.",
    ...
    major: [
      {
        ...
        reason:
          "Level 6 is a huge power spike for Annie, as (R) gives her a strong pick tool and significant burst damage",
        changesGameplay:
          "Annie's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Annie's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Annie's first item threshold is completed.",
      },
    ],
  },
  primaryRoles: ["mid"],
