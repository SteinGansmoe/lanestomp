...
export const milioCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A spacing lane where Milio keeps his ADC at max range, shields short trades, and saves (Q) for engage denial.",
    wants: ["Scaling ADC protected.", "Long auto trade windows.", "Enemies relying on CC engage."],
  },
  laneIdentity: {
  ...
  majorPowerSpikes: [
    "Level 2 shield plus peel.",
    "Level 3 range zone.",
    "Level 6 Breath of Life cleanse.",
  ],
  matchupPreferences: {
    strongInto: [
      "CC engage lanes.",
  ...
  primaryTradingPattern:
    "Stand behind the ADC, extend range with (W), shield trade windows, and hold (Q) for enemy engage.",
  punishProfile: {
    canPunish: [
