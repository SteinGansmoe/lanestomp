...
export const zyraCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A poke-control lane where Zyra owns brush with seeds, roots enemies through wave gaps, and punishes engage with plant zones.",
    wants: ["Brush control.", "ADC follow-up on root.", "Enemy forced through plant zones."],
  },
  laneIdentity: {
    earlyGameAgency: "high",
    lanePressure: "high",
    preferredGameState: ["Poke lanes.", "Zone-control objective fights.", "Anti-engage with (R)."],
    scalingPriority: "medium",
    winLaneBy: ["Landing root.", "Controlling brush with plants.", "Forcing enemies through (R)."],
  },
  majorPowerSpikes: [
    "Level 2 root plus plant poke.",
    "Level 3 stronger seed control.",
    "Level 6 Stranglethorns.",
  ],
  matchupPreferences: {
    strongInto: ["Short-range lanes.", "Low-sustain ADCs.", "Engage that clumps into plants."],
    weakInto: ["Hook supports.", "Long-range artillery.", "Mobile ADCs dodging root."],
  },
  mobilityLevel: "none",
  name: "Zyra",
  offMetaRoles: [],
  ...
  primaryTradingPattern:
    "Seed brush, threaten (E), and use plants to punish every CS attempt while holding (R) for committed fights.",
  punishProfile: {
    canPunish: [
  ...
  sustain: [],
  trading: {
    badTradeConditions: ["(E) misses.", "Seeds are down.", "She is forced out of brush."],
    goodTradeConditions: [
      "Brush is seeded.",
  ...
  punishWindows: ["Clear plants safely.", "Engage after (E) misses.", "Avoid clumping for (R)."],
