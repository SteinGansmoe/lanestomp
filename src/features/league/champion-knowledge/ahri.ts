...
export const ahriCombatProfile = {
  ...
  debugNote: "",
  primaryWinCondition: [
    "Land (E) to pick off targets and snowball leads.",
    "Clear waves and look for playmaking opportunities with (R) mobility.",
    "Poke with (Q) and (W) to create pressure and look for (E) angles.",
  ],
  dangerAbilities: ["(E)"],
  dangerProfile: {
    dangerousWhen: [
  ...
  powerSpikes: {
    major: [
      ...
      },
      {
        ...
        enemyResponse:
          "Do not treat pre-item trades as still safe once Ahri's first item threshold is completed.",
      },
    ],
    minor: [
      {
        ...
        changesGameplay:
          "Ahri has more short-trade options, but this is context for lane trading rather than her main kill spike.",
        playerAction:
          "Use the extra flexibility for short (Q) and (W) trades while saving (E) for real punish windows.",
        enemyResponse:
          "Do not overreact to level 3 alone; respect (E) angles and punish if she spends (E) carelessly.",
      },
    ],
  },
  primaryRoles: ["mid"],
