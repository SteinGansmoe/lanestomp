...
export const aniviaCombatProfile = {
  ...
  primaryWinCondition: [
    "Farm up and use her strong waveclear and zoning to control the lane and look for picks.",
  ],
    ...
    major: [
      {
        ...
        changesGameplay:
          "Anivia's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Anivia's first item threshold is completed.",
      },
      {
        timing:
          "It is hard to siege into Anivia after 6 because of her (R), so she can often get picks or force fights on her terms",
        reason:
          "It is hard to siege into Anivia after 6 because of her (R), so she can often get picks or force fights on her terms",
        changesGameplay:
          "This timing changes how safely Anivia can contest trades, waves, or river space.",
        playerAction:
          "Change trading pace only when this timing is active and the enemy has no clean punish window.",
  ...
  sustain: [""],
  trading: {
    badTradeConditions: ["If Anivia misses (Q), thats when to punish her."],
    goodTradeConditions: [],
    primaryPattern:
      "(Q) is her main trading and pick tool, (E) is her main damage tool, and (R) is her main zoning and teamfight tool.",
  },
  punishWindows: ["If Anivia misses (Q), thats when to punish her."],
