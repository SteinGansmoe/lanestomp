...
export const luluCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A protected scaling lane where Lulu shields ADC trades, holds polymorph for the enemy commit, and avoids unnecessary all-ins.",
    wants: [
  ...
  laneIdentity: {
    ...
    winLaneBy: [
      ...
      "Polymorphing engage.",
      "Scaling into carry protection.",
  ],
  },
  majorPowerSpikes: ["Level 2 shield and polymorph trade.", "Level 3 adds slow/poke control.", "Level 6 Wild Growth counter-engage."],
  matchupPreferences: {
    strongInto: [
      "Dive comps.",
      "Short-range all-in lanes.",
      "Games centered on one carry.",
  ],
    weakInto: [
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Shield the ADC's trade, hold polymorph for the enemy's main commit, and turn dives with (R).",
  punishProfile: {
    canPunish: [
  ...
  trading: {
    ...
    primaryPattern: "Shield the ADC's trade, hold polymorph for the enemy's main commit, and turn dives with (R).",
  },
  punishWindows: [
