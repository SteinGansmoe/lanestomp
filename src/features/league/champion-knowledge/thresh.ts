...
export const threshCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A control lane where Thresh threatens hook from brush, holds Flay for dashes, and uses lantern to manage ADC risk.",
    wants: ["Brush control.", "ADC follow-up or protection.", "Enemy dash to interrupt."],
  },
  laneIdentity: {
    earlyGameAgency: "high",
    lanePressure: "high",
    preferredGameState: ["Pick lanes.", "Protected immobile carries.", "Gank setup lanes."],
    scalingPriority: "medium",
    winLaneBy: ["Landing hook.", "Flaying engage.", "Lanterning ADC or jungler."],
  },
  majorPowerSpikes: [
    "Level 2 hook plus Flay.",
    "Level 3 lantern safety.",
    "Level 6 The Box all-in or peel.",
  ],
  matchupPreferences: {
    strongInto: ["Immobile ADCs.", "Dash engage he can Flay.", "Lanes that fear ganks."],
    weakInto: ["Long-range poke.", "Spell shields.", "Minion cover lanes."],
  },
  counters: [
    {
      champion: "Leona",
  ...
  primaryTradingPattern:
    "Hold hook threat, Flay enemy dashes or pulls, and use lantern to let ADCs trade closer than they normally could.",
  punishProfile: {
    canPunish: [
    ...
    strugglesToPunish: ["Full minion waves.", "Poke lanes.", "Spell-shielded targets."],
  },
  ...
  sustain: [],
  trading: {
    badTradeConditions: ["(Q) misses.", "(E) is down against engage.", "Lantern is unavailable."],
    goodTradeConditions: [
      "Brush is controlled.",
  ...
  punishWindows: ["Stand behind minions.", "Punish missed hook.", "Ward lantern gank paths."],
