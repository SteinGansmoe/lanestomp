...
export const jannaCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A stable or slightly defensive lane where Janna shields key trades, controls brush with tornado threat, and prevents hard engage.",
    wants: [
  ...
  majorPowerSpikes: [
    "Level 2 shield plus disengage.",
    "Level 3 full peel kit.",
    "Level 6 (R) fight reset.",
  ],
  matchupPreferences: {
    strongInto: ["Hard engage supports.", "Dive ADCs.", "Comps relying on one entry path."],
    weakInto: [
  ...
  primaryTradingPattern:
    "Shield the ADC's best auto trade, hold (Q) for enemy engage, and use (W) only when she can back out safely.",
  punishProfile: {
    canPunish: [
      "Telegraphed engage.",
