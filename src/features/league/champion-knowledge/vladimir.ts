...
export const vladimirCombatProfile = {
  ...
  primaryWinCondition: [
    "Survive early lane through sustain, scale into AP spikes, and threaten grouped fights with (R) burst.",
  ],
  dangerAbilities: ["(W) untargetability", "(R) teamfight burst", "(Q) empowered (Q)"],
  dangerProfile: {
    dangerousWhen: [
  ...
  powerSpikes: {
    major: [
      ...
      },
      {
        ...
        enemyResponse:
          "Do not treat pre-item trades as still safe once Vladimir's first item threshold is completed.",
      },
      {
        timing: "Mid-game item progression",
        reason: "Mid-game AP and cooldown spikes",
        changesGameplay:
          "This timing changes how safely Vladimir can contest trades, waves, or river space.",
        playerAction:
  ...
  stealthOrInvisibility: "(W) makes Vladimir untargetable.",
  sustain: ["(Q) healing", "Empowered (Q) stronger healing"],
  trading: {
    badTradeConditions: [
