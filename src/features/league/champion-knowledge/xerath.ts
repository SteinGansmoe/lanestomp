...
export const xerathCombatProfile = {
  ...
  primaryWinCondition: [
    "Use (Q) and (W) to control space and poke, can have decent map pressure post level 6 due to his ultimate.",
  ],
    ...
    major: [
      {
        ...
        reason: "Level 6 (R)",
        changesGameplay:
          "Xerath's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Xerath's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Xerath's first item threshold is completed.",
      },
    ],
  },
  ...
  punishWindows: ["If Xerath uses (E) and misses he has to play back.", "When charging his (Q)."],
