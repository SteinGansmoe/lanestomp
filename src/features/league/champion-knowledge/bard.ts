...
export const bardCombatProfile = {
  ...
  abilities: { Q: "Cosmic Binding", W: "Caretaker's Shrine", E: "Magical Journey", R: "Tempered Fate" },
  ...
  lanePlan: {
    ...
    idealLaneState: "A stable wave where Bard can trade with meeps, threaten wall stuns from brush, and leave after crashing or resetting the lane.",
    wants: [
  ...
  majorPowerSpikes: ["Level 2 (Q)+(W) trade setup.", "Level 3 unlocks roam paths with (E).", "Level 6 (R) changes pick and dive setups."],
  matchupPreferences: {
    strongInto: [
      "Immobile bot lanes near walls.",
      "Passive lanes that cannot punish roams.",
  ],
    weakInto: [
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Trade with meep autos, look for (Q) wall stuns from brush, and roam only after the wave state protects his ADC.",
  punishProfile: {
    canPunish: [
      "Targets near walls.",
  ...
  strategicIdentity: {
    ...
    scalingProfile: "late",
    winMethod: ["Landing wall stuns.", "Creating numbers advantages with roams.", "Using shrines to keep ADC healthy."],
  },
  supportSynergy: {
  ...
  trading: {
    ...
    primaryPattern: "Trade with meep autos, look for (Q) wall stuns from brush, and roam only after the wave state protects his ADC.",
  },
  punishWindows: [
