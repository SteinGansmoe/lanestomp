...
export const swainCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A pull-threat lane where Swain controls minion angles, lands (E), and forces extended fights only when his ADC can follow.",
    wants: [
      "Enemy in pull range.",
      "ADC burst after root.",
      "Close river skirmishes.",
  ],
  },
  laneIdentity: {
    ...
    winLaneBy: [
      "Landing (E).",
      "Pulling targets into ADC damage.",
      "Sustaining with (R).",
  ],
  },
  majorPowerSpikes: ["Level 2 (E)+(Q) pull trade.", "Level 3 adds long-range vision/poke.", "Level 6 Demonic Ascension."],
  matchupPreferences: {
    strongInto: [
      "Short-range ADCs.",
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Threaten (E) from minion angles, pull only when ADC can damage, and commit after level 6 when enemies must stay in his drain zone.",
  punishProfile: {
    canPunish: [
      "ADCs with no dash.",
  ...
  trading: {
    badTradeConditions: [
      "(E) misses.",
      "He is kited outside (R).",
      "His ADC cannot follow pull.",
  ],
    goodTradeConditions: [
    ...
    primaryPattern: "Threaten (E) from minion angles, pull only when ADC can damage, and commit after level 6 when enemies must stay in his drain zone.",
  },
  punishWindows: [
    "Dodge (E), then punish.",
    "Kite out his (R).",
    "Outrange him with poke.",
  ],
