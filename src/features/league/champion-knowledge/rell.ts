...
export const rellCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A kill lane where Rell hides engage range, crashes onto priority targets, and chains CC while her ADC unloads damage.",
    wants: ["ADC ready for all-in.", "Enemy wave thin enough to enter.", "Grouped targets."],
  },
  laneIdentity: {
    earlyGameAgency: "high",
    lanePressure: "high",
    preferredGameState: ["All-in lanes.", "Dragon fights.", "Grouped teamfights."],
    scalingPriority: "medium",
    winLaneBy: ["Landing multi-target engage.", "Chaining CC.", "Roaming after wave crash."],
  },
  ...
  primaryTradingPattern:
    "Enter from brush or flank with (W), layer (E), then use (R) when enemies try to split from the engage.",
  punishProfile: {
    canPunish: ["Grouped enemies.", "ADCs without flash.", "Supports using disengage early."],
    strugglesToPunish: [
      "Spread targets.",
      "Long-range poke.",
  ...
  sustain: [],
  trading: {
    badTradeConditions: ["(W) misses.", "She is dismounted in poke range.", "ADC cannot follow."],
    goodTradeConditions: [
      "Enemy wave is thin.",
  ...
  punishWindows: ["Poke before she enters.", "Spread for (R).", "Punish failed crash down."],
