...
export const renataCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A controlled lane where Renata shields trades, saves (W) for lethal moments, and punishes engages with displacement.",
    wants: [
      "Extended ADC trades.",
      "Enemy dive into her backline.",
      "Choke fights for (R).",
  ],
  },
  laneIdentity: {
  ...
  majorPowerSpikes: ["Level 2 shield and trade tools.", "Level 3 Bailout changes all-ins.", "Level 6 Hostile Takeover."],
  matchupPreferences: {
    strongInto: [
      "Dive lanes.",
      "Auto-attack carries.",
      "ADCs that love extended fights.",
  ],
    weakInto: [
      "Long-range poke.",
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Shield and slow with (E), hold (Q) for the commit, and use Bailout only when the ADC can actually reset or finish the fight.",
  punishProfile: {
    canPunish: [
  ...
  strategicIdentity: {
    ...
    scalingProfile: "late",
    winMethod: ["Timing Bailout.", "Stopping divers with (Q).", "Casting (R) through grouped enemies."],
  },
  supportSynergy: {
  ...
  trading: {
    ...
    primaryPattern: "Shield and slow with (E), hold (Q) for the commit, and use Bailout only when the ADC can actually reset or finish the fight.",
  },
  punishWindows: [
