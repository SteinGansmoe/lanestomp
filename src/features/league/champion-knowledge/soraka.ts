...
export const sorakaCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A sustain lane where Soraka lands (Q), keeps ADC healthy, and uses silence to stop engage paths or burst combos.",
    wants: [
  ...
  laneIdentity: {
    ...
    lanePressure: "low",
    preferredGameState: ["Sustain lanes.", "Anti-burst fights.", "Scaling carry protection."],
    scalingPriority: "high",
    winLaneBy: ["Landing (Q).", "Keeping ADC healthy.", "Silencing enemy engage."],
  },
  majorPowerSpikes: ["Level 2 heal plus poke.", "Level 3 silence control.", "Level 6 global Wish."],
  matchupPreferences: {
    strongInto: ["Poke lanes.", "Burst lanes that need one combo.", "Scaling ADCs."],
    weakInto: ["Hard engage.", "Hook supports.", "Assassins that target her first."],
  },
  mobilityLevel: "none",
  name: "Soraka",
  offMetaRoles: [],
  ...
  primaryTradingPattern:
    "Land (Q) for rejuvenation, heal the ADC after favorable trades, and save (E) to interrupt engage or trap exits.",
  punishProfile: {
    canPunish: [
  ...
  trading: {
    badTradeConditions: ["(Q) misses.", "Her health is low.", "(E) is used before engage."],
    goodTradeConditions: [
