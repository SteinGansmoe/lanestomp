...
export const velkozCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState:
      "A long-range poke lane where Vel'Koz uses split (Q) angles and wave pressure while saving (E) for disengage or guaranteed burst.",
    wants: ["Open poke angles.", "ADC that adds long-range damage.", "Enemy without hard engage."],
  },
  laneIdentity: {
    ...
    winLaneBy: ["Landing repeated (Q).", "Saving (E).", "Finishing with (R)."],
  },
  majorPowerSpikes: [
    "Level 2 poke plus knockup.",
    "Level 3 full poke pattern.",
    "Level 6 laser burst.",
  ],
  matchupPreferences: {
    strongInto: ["Short-range lanes.", "Low-sustain ADCs.", "Immobile carries."],
    weakInto: ["Hard engage.", "Hook supports.", "Mobile ADCs that dodge skillshots."],
  },
  mobilityLevel: "none",
  name: "Vel'Koz",
  offMetaRoles: [],
  ...
  primaryTradingPattern:
    "Use split (Q) angles to avoid minion cover, layer (W), and hold (E) unless the hit is guaranteed or needed for peel.",
  punishProfile: {
    canPunish: [
    ...
    strugglesToPunish: ["Fast engage.", "High sustain.", "Targets who can interrupt (R)."],
  },
  shields: [],
  ...
  sustain: [],
  trading: {
    badTradeConditions: ["(E) misses.", "He channels (R) without peel.", "Brush control is lost."],
    goodTradeConditions: ["Enemy is slowed.", "ADC adds poke.", "Engage cooldowns are down."],
    primaryPattern:
      "Use split (Q) angles to avoid minion cover, layer (W), and hold (E) unless the hit is guaranteed or needed for peel.",
  },
  punishWindows: ["Engage after (E) misses.", "Approach through side brush.", "Interrupt (R)."],
