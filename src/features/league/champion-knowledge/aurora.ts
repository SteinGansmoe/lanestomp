...
export const auroraCombatProfile = {
    ...
    major: [
      {
        ...
        changesGameplay:
          "Aurora's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Aurora's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Aurora's first item threshold is completed.",
      },
    ],
  },
  primaryRoles: ["mid"],
  ...
  stealthOrInvisibility:
    "(W) gives a brief burst of movement speed and invisibility, allowing Aurora to dodge skillshots and reposition in fights.",
  sustain: [""],
  trading: {
    badTradeConditions: [
