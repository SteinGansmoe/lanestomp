...
export const hweiCombatProfile = {
    ...
    primaryWinCondition: ["Use long-range poke and (E) spellbook CC to control the lane and set up for level 6 all-in with (R)."],
    ...
    lanePlan: {
      ...
      wants: ["Use long-range poke and (E) spellbook CC to control the lane and set up for level 6 all-in with (R)."],
    },
    laneIdentity:
      {
      ...
      lanePressure: "high",
      preferredGameState: ["Use long-range poke and (E) spellbook CC to control the lane and set up for level 6 all-in with (R)."],
      winLaneBy: ["Use long-range poke and (E) spellbook CC to control the lane and set up for level 6 all-in with (R)."],
    },
    majorPowerSpikes: [
