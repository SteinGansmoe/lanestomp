...
export const hweiCombatProfile = {
  ...
  primaryWinCondition: [
    "Use long-range poke and (E) spellbook CC to control the lane and set up for level 6 all-in with (R).",
  ],
    ...
    major: [
      {
        ...
        reason: "Level 6 (R)",
        changesGameplay:
          "Hwei's ultimate becomes available, so the matchup shifts around whether the commit, pick, roam, or escape threat is ready.",
        playerAction:
      ...
      },
      {
        ...
        changesGameplay:
          "Hwei's damage, wave control, or trade reliability improves enough that earlier neutral trades can become losing trades.",
        playerAction:
          "After the item, pressure waves and trades more confidently while still tracking the enemy's main answer.",
        enemyResponse:
          "Do not treat pre-item trades as still safe once Hwei's first item threshold is completed.",
      },
    ],
    minor: [
      {
        ...
        changesGameplay:
          "Hwei gains access to his full toolkit, but the spike is about options and safety more than sudden lethal pressure.",
        playerAction:
          "Use the extra spellbook coverage to control space, thin waves, and keep defensive tools available.",
        enemyResponse:
          "Pressure him when key control or shield options are spent instead of treating level 3 as an all-in spike.",
      },
    ],
  },
  primaryRoles: ["mid"],
