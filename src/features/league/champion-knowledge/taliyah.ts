...
export const taliyahCombatProfile = {
  ...
  dangerAbilities: ["W Seismic Shove displacement", "E Unraveled Earth anti-dash zone"],
  dangerProfile: {
    dangerousWhen: [
  ...
  damageType: "magic",
  hardCrowdControl: ["W Seismic Shove displacement"],
  id: "Taliyah",
  ...
  shields: [],
  softCrowdControl: ["E Unraveled Earth slow"],
