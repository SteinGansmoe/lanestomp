...
export const nautilusCombatProfile = {
  ...
  lanePlan: {
    ...
    idealLaneState: "A thin-wave lane where Nautilus controls brush and threatens hook into passive root whenever the enemy ADC steps up.",
    wants: [
      "Brush control.",
      "Burst ADC follow-up.",
      "Thin enemy wave.",
  ...
  laneIdentity: {
    ...
    winLaneBy: [
      "Landing hook.",
      "Layering passive root.",
      "Using (R) to guarantee follow-up.",
  ],
  },
  majorPowerSpikes: ["Level 2 hook plus passive.", "Level 3 shield and slow.", "Level 6 Depth Charge."],
  matchupPreferences: {
    strongInto: [
      "Immobile ADCs.",
      "Enchanters without disengage.",
      "Bot lanes with weak level 2.",
  ],
    weakInto: [
      "Poke lanes that keep him low.",
      "Spell shields.",
      "Disengage after hook.",
  ],
  },
  ...
  secondaryRoles: [],
  primaryTradingPattern: "Threaten hook from brush, auto for passive after connecting, and save (R) for targets who can dodge (Q).",
  punishProfile: {
    canPunish: [
  ...
  trading: {
    ...
    goodTradeConditions: [
      "Level 2 first.",
      "Enemy flash is down.",
      "Brush hides hook angle.",
  ],
    primaryPattern: "Threaten hook from brush, auto for passive after connecting, and save (R) for targets who can dodge (Q).",
  },
  punishWindows: [
    "Punish missed hook.",
    "Stand behind minions.",
    "Poke before he can engage.",
  ],
