...
export function buildLeagueMatchupDraftPrompt({
  ...
  return {
    systemPrompt: [
      ...
      `Use ${enemyChampionName} Q, ${enemyChampionName} W, ${enemyChampionName} E, or ${enemyChampionName} R for enemy champion abilities.`,
    ...
    userPrompt: [
      ...
      `If source profile text names a mapped ${enemyChampionName} ability, shorten it to ${enemyChampionName} Q, ${enemyChampionName} W, ${enemyChampionName} E, or ${enemyChampionName} R in the returned JSON.`,
      ...
      `- Do not write ${playerChampionName} Q, ${playerChampionName} W, ${playerChampionName} E, or ${playerChampionName} R for the player champion; use bare Q, W, E, or R.`,
      `- Do not write bare Q, W, E, or R for ${enemyChampionName}; use ${enemyChampionName} Q, ${enemyChampionName} W, ${enemyChampionName} E, or ${enemyChampionName} R.`,
      ...
      `- Did enemy abilities use ${enemyChampionName} Q, ${enemyChampionName} W, ${enemyChampionName} E, or ${enemyChampionName} R?`,
