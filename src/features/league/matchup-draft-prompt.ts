...
const supportPromptRules = [
  ...
  "- Support card text must never assume supports are farming minions.",
  "- Support card text must avoid CS, farming, last-hit, last hits, farm, deny farm, and farming-lane language.",
  "- Replace support farming concepts with ADC access, engage access, brush control, hook pressure, roam windows, vision control, peel opportunities, and follow-up windows.",
  "- Do not tell supports to punish minion farming, trade aggressively into the enemy support, or fight the enemy support after a cooldown miss unless the sentence clearly explains ADC access, ADC follow-up, brush control, or lane-state control.",
...
export function buildLeagueMatchupDraftPrompt({
  ...
  return {
    ...
    userPrompt: [
      ...
      "For support matchups, never write as if either support farms minions; translate farming or CS ideas into ADC access, engage access, brush control, hook pressure, roam windows, vision control, peel opportunities, or follow-up windows.",
      ...
      `- Better: Control brush so your ADC can access the wave while ${enemyChampionName}'s engage angle is denied.`,
      ...
      `- Better support framing: Deny ${enemyChampionName}'s engage access with brush control and ADC follow-up ready.`,
      "",
      ...
      `early_game: For support, cover level 2 race, brush control, lane priority, wave crash, ADC wave access, and safe roam or ward timing.`,
      ...
      "- For support matchups, do not tell the support to punish CS, contest last hits, farm, deny farm, or trade aggressively into the enemy support.",
      "- For support matchups, replace farming language with ADC access, engage access, brush control, hook pressure, roam windows, vision control, peel opportunities, or follow-up windows.",
      ...
      "- For support matchups, did it avoid all support farming assumptions and replace CS/farming language with support-specific access, vision, peel, roam, hook, brush, or follow-up language?",
...
function getRolePromptGuidance(role: LeagueRole) {
  ...
  return [
    ...
    "Never assume supports farm minions; replace CS, farm, farming, and last-hit concepts with ADC access, engage access, brush control, hook pressure, roam windows, vision control, peel opportunities, or follow-up windows.",
