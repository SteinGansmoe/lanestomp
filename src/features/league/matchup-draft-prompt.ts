...
const writingStyleRules = [
  ...
  "- Do not start bullets with Identify, Build, Choose, Respect, Treat, Review, Explain, List, Keep, or Convert.",
...
export function buildLeagueMatchupDraftPrompt({
  ...
  return {
    ...
    userPrompt: [
      ...
      "Every bullet should explain why the decision is correct through matchup dynamics, lane state, tempo, cooldowns, vision, objectives, scaling, or champion strengths.",
      "Do not start any returned bullet with Identify, Build, Choose, Respect, Treat, Review, Explain, List, Keep, or Convert.",
      ...
      "- Bad: Apply pressure.",
      "- Better: Hold the wave near your side and punish every CS attempt with auto attacks or confirmed abilities.",
      ...
      "- Better: If you have a numbers disadvantage, trade the tempo window into top-side camps, Void Grubs, Herald, or vision instead of flipping the dragon fight.",
      "",
      ...
      "- Did every returned bullet avoid starting with Identify, Build, Choose, Respect, Treat, Review, Explain, List, Keep, or Convert?",
      "- Did every returned value avoid prompt-language words such as review, list only, keep, before publishing, verified, output, instruction, JSON, schema, section, bullet, admin, return, or rewrite?",
