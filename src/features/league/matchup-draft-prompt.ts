...
export function buildLeagueMatchupDraftPrompt({
  ...
  return {
    systemPrompt: [
      ...
      "Use (Q), (W), (E), or (R) for player champion abilities in generated bullets.",
      `Use ${enemyChampionName}'s (Q), ${enemyChampionName}'s (W), ${enemyChampionName}'s (E), or ${enemyChampionName}'s (R) for opponent abilities.`,
      "Never use full ability names in generated card text when the ability is known.",
    ...
    userPrompt: [
      ...
      `If source profile text names a mapped ${enemyChampionName} ability, shorten it to ${enemyChampionName}'s (Q), ${enemyChampionName}'s (W), ${enemyChampionName}'s (E), or ${enemyChampionName}'s (R) in the returned JSON.`,
      ...
      "- Better: Respect Syndra's (E) cooldown.",
      ...
      "- Better: When Veigar's (E) is down, step forward to pressure trades or force him away from the wave.",
      ...
      `- Do not write ${playerChampionName} Q, ${playerChampionName} W, ${playerChampionName} E, or ${playerChampionName} R for the player champion; use (Q), (W), (E), or (R).`,
      `- Do not write bare Q, W, E, or R for ${enemyChampionName}; use ${enemyChampionName}'s (Q), ${enemyChampionName}'s (W), ${enemyChampionName}'s (E), or ${enemyChampionName}'s (R).`,
      ...
      "- Did player abilities use only (Q), (W), (E), or (R)?",
      `- Did enemy abilities use ${enemyChampionName}'s (Q), ${enemyChampionName}'s (W), ${enemyChampionName}'s (E), or ${enemyChampionName}'s (R)?`,
